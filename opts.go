...
func ParseOpts() *Opts {
	...
	flag.Uint64Var((*uint64)(&opts.Server), "server", 0,
		"Specify a server ID to test against")
	flag.StringVar(&opts.Interface, "interface", "",
		"IP address of network interface to bind to")
	flag.DurationVar(&opts.Timeout, "timeout", 10*time.Second,
		"HTTP timeout duration. Default 10s")
