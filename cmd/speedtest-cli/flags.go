...
var (
	...
	cfgTime  = flag.Duration("time.config", 10*time.Second, "Timeout for getting initial configuration")
	pngTime  = flag.Duration("time.latency", 10*time.Second, "Timeout for latency detection phase")
